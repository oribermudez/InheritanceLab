...
namespace InheritanceLab.Classes
{
    internal class Waged : Employee
    {
        ...
        public const int WORKING_HOURS = 40;
        public const double OVERTIME_PAY_RATE = 1.5;
        ...
        public override double Pay
        {
            get
            {
                ...
                {
                    double overtimeHours = hours - WORKING_HOURS;
                    double overtimePay = overtimeHours * (rate * OVERTIME_PAY_RATE);

                    pay = (rate * WORKING_HOURS) + overtimePay;
                }
                else
                {
                    pay = rate * hours;
        ...
        /// <summary>
        /// User-defined Waged class constructor
        /// </summary>
